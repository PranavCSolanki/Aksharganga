  ...
  return (
    <>
      ...
      <div className={styles.containers}>
        ...
        >
          <div className="text-xl font-bold m-8  bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text hover:from-red-400 hover:to-yellow-400 ">
            Exam :- {exam}
          </div>
        </div>
      ...
      <div className={`${styles.containers} w-full p-8 rounded-lg shadow-2xl`}>
